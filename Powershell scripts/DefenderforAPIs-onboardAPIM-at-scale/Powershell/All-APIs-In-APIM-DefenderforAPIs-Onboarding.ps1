...
$queryResult = az graph query -q "Resources | where type =~ 'Microsoft.ApiManagement/service' and name == '$apimServiceName' and subscriptionId == '$subscriptionId' | project id, name, resourceGroup, subscriptionId" -o json | ConvertFrom-Json
